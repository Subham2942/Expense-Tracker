...
import { authenticate, AuthMode } from '@/services/auth-api';

// UI and form validation for the public login/signup route.
...
export default function AuthScreen() {
  ...
  async function submit() {
    ...
    try {
      ...
      setFeedback(null);
      const tokens = await authenticate(mode, payload);
      await login(tokens);
    } catch (error) {
